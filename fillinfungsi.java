...
public class fillinfungsi
{
	public static void main( String[] args )
	{
		...
		char c = '!';
		randchar();
		System.out.println("The character is: " + c  + randchar());
	...
	{
		String result = "";
		String name = "abinaya arya ";																	// displays some boilerplate text saying who wrote this program, etc.
